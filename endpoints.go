...
var (
	...
	*/
	...
	/*
		...
		AUCTION
		AUCTION DATA STATUS /WOW/AUCTION/DATA/:REALM

		BOSS
		MASTER LIST /WOW/BOSS/
		BOSS /WOW/BOSS/:BOSSID

		CHALLENGE MODE
		REALM LEADERBOARD /WOW/CHALLENGE/:REALM
		REGION LEADERBOARD /WOW/CHALLENGE/REGION
